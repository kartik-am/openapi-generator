...
[Master](https://github.com/OpenAPITools/openapi-generator/tree/master) (`6.6.2-amadeus`):
...
| 6.6.2-amadeus (upcoming minor release) [SNAPSHOT](https://oss.sonatype.org/content/repositories/snapshots/org/openapitools/openapi-generator-cli/6.6.2-amadeus-SNAPSHOT/) | 28.04.2023   | Minor release with breaking changes (with fallback) |
